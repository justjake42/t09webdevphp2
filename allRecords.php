...
<table border="1">
<tr>
<td colspan="7">TRANSACTIONS LIST<br><a href="insertTransactionData.php"> New Record</a></br></td>
</tr>
<tr>
...
<td><a href="processUpdate.php?id=<?php echo $row["id"]; ?>">Update</a><!--<a href="deleteProcess.php?id=<//?php echo $row["id"]; ?>">Delete</a>-->
</td>
</tr>
